...
export module PersonStore {
    ...
    export const actionCreators = {
        searchRequest: (term?: string): AppThunkAction<KnownAction> => async (dispatch, _getState) => {
            
            await wait(async (_transformUrl) => {
        ...
        addRequest: (model: IPersonModel): AppThunkActionAsync<KnownAction, Result<number>> => async (dispatch, _getState) => {
        ...
        updateRequest: (model: IPersonModel): AppThunkActionAsync<KnownAction, Result<{}>> => async (dispatch, _getState) => {
        ...
        deleteRequest: (id: number): AppThunkAction<KnownAction> => async (dispatch, _getState) => {
