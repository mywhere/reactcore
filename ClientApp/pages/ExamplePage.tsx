...
class ExamplePage extends React.Component<Props, IState> {
    ...
    @bind
    onClickShowAddModal(_e: React.MouseEvent<HTMLButtonElement>) {
        this.elModalAdd.show();
    }

    @bind
    onClickShowEditModal(_e: React.MouseEvent<HTMLButtonElement>, modelForEdit: IPersonModel) {
        this.setState({ modelForEdit });
        this.elModalEdit.show();
    }

    @bind
    onClickShowDeleteModal(_e: React.MouseEvent<HTMLButtonElement>, modelForEdit: IPersonModel) {
        this.setState({ modelForEdit });
    ...
    @bind
    onClickPersonEditorDelete__saveBtn(_e: React.MouseEvent<HTMLButtonElement>): void {
